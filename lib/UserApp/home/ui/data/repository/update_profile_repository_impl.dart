...
class UpdateProfileRepositoryImpl implements UpdateProfileRepository {
  ...
  @override
  Future<UpdateProfileEntity> profileUpdate(String userId,String mobile,String email,String firstname,String lastname,String gender,String dob,String image) async {
    final UpdateProfileModel updateProfileModel = await updateProfileDatasource.profileUpdate(userId,mobile,email,firstname,lastname,gender,dob,image);
